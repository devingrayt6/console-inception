...
namespace inception.Models
{
  class Game : IGame
  {
    ...
    public Game()
    {
      ...
      Room hallWay = new Room("Hall Way", "You are in the Hall Way...There is a door at the end of the hall (east) that appears to be locked.");
      ...
      Item note1 = new Item("note", "A crumpled paper. A note that says pass: 11...");
      Item note2 = new Item("note", "A crumpled paper. A note that says pass: 12...");
      Item key = new Item("key", "A gold key...[use key] to use this item.");
      ...
      hallWay.AddLockedRoom(key, "east", tvRoom);
      ...
      backPlane.Items.Add(note1);
      classRoom.Items.Add(note2);
      frontPlane.Items.Add(key);
